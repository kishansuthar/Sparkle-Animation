...
//  SparkLayer
//
//  Created by Kishan Suthar on 26/05/20.
...
class ViewController: UIViewController {
    ...
    func addStarAnimation(onLocation aLoc: CGPoint){
        ...
        let aStarLayer = SparkleLayer(frame:  CGRect(x: aLoc.x - 50, y: aLoc.y - 50, width: 100, height: 100), image: UIImage(named: setting.imageName)!, count: setting.count, size: setting.size)
